...
function main() {
  ...
  let resourceInfluence = exploreEnvironment(city, cityOrigin, resources, false, svgSpace);
  // drawResourceInfluence(resourceInfluence, cityOrigin, svgSpace);

  for (let i = 0, n = 175; i < n; i++) {
    city = extendCityTerritory(city, cityOrigin, resourceInfluence, .2 , 1)
    drawPolygon(city, svgSpace, "white", .05);
  }
  // drawPolygon(city, svgSpace, "white", 1);
}
